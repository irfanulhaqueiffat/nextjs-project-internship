...
<div className=""><p>Concern of Creative Business Group</p>
  ...
  <div>
      ...
      <ul>
        <li className="flex items-center gap-3px flex-wrap"> <SiGooglemaps />123 Construction Ave, Dhaka, Bangladesh</li>
        <li className="flex items-center  gap-3px"> <FaPhone /> +880 1234-567890</li>
        <li className="flex items- centergap-3px"> <CiMail /> info@buildtech.com</li>
         <li className="flex gap-3px"> <FaRegClock /> Mon-Sat, 9:00 AM – 6:00 PM</li>
      </ul>
    </div>
